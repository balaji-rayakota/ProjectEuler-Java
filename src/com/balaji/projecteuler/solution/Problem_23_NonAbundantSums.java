 ...
 * of 28 would be 1 + 2 + 4 + 7 + 14 = 28, which means that 28 is a perfect number.<br>
 ...
 * limit cannot be reduced any further by analysis even though it is known that the greatest number that cannot be expressed as the sum of two
 * abundant numbers is less than this limit.<br>
