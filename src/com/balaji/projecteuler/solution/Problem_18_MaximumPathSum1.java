...
/**
 * By starting at the top of the triangle and moving to adjacent numbers on the row below find the maximum total from top to bottom of the triangle
 * given in data file corresponding to this problem.
...
public class Problem_18_MaximumPathSum1
{
     ...
     * @param path
     *            The String path of file with data.
     * @throws IOException
     ...
     * @param path
     *            The String path of the file (cannot be blank).
     ...
     * @param size
     *            the size of the array to be created (must be positive).
