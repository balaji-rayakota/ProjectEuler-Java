...
/**
 * Considering quadratics of the form: n^2+an+b, where |a|<1000|a|<1000 and
 * |b|≤1000 <br>
...
public class Problem_27_QuadraticPrimes {
	...
	public static void main(final String[] args) {
		...
		System.out.println(
				String.format("maximum primes = %d for a = %d and b = %d, a*b = %d", max, a_max, b_max, a_max * b_max));
	}
	 ...
	 * 
	 * @param max
	 *           The maximum integer till which primes are to be calculated(must be
	 *           positive).
