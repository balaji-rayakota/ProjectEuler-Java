...
/**
 * The text data file contains over five-thousand first names, begin by sorting it into alphabetical order. Then working out the alphabetical value
 * for each name, multiply this value by its alphabetical position in the list to obtain a name score.<br>
...
public class Problem_22_NamesScore
{
     ...
     * @return 1, 0, -1 if str1 is greater than, equal to, and less than str2 respectively.
     */
